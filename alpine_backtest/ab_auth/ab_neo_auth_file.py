...
# Credentials
neo_client_id = ab_cred.neo_client_id
neo_username = ab_cred.neo_username
neo_password = ab_cred.neo_password
neo_mobile_number = ab_cred.neo_mobile_number
neo_mobile_password = ab_cred.neo_mobile_password
neo_user_id = ab_cred.neo_user_id
...
def authenticate(client_id, username, password, mobile_number, mobile_password, user_id):
    ...
    with open("./ab_auth/ab_neo_token_obj.json", "w") as outfile:
        json.dump(token_obj, outfile)
    print("Tokens saved to ab_neo_token_obj.json")
