...
from alpine_market.am_executor.am_oe import am_oei,ltp_thread_fun,neo_order_feed_fun,timeframe_manager_loop_fun,candle_data_loop_fun,script_creator_manager_fun
...
if __name__ == "__main__":
    ...
    SCRIPT_CSV_FILE_PATH=r"am_files_active/active_script.csv"
    ...
    thNeoOrderFeed = multiprocessing.Process(target=neo_order_feed_fun,args=(SHARED_PROCESS_HOLD_FLAG,lock))
