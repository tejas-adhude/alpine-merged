...
# Credentials
neo_client_id = am_cred.neo_client_id
neo_username = am_cred.neo_username
neo_password = am_cred.neo_password
neo_mobile_number = am_cred.neo_mobile_number
neo_mobile_password = am_cred.neo_mobile_password
neo_user_id = am_cred.neo_user_id
...
def authenticate(client_id, username, password, mobile_number, mobile_password, user_id):
    ...
    with open("./am_auth/am_neo_token_obj.json", "w") as outfile:
        json.dump(token_obj, outfile)
    print("Tokens saved to am_neo_token_obj.json")
